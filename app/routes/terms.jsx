export default function TermsOfServicePage() {
  return (
    <article className="prose lg:prose-lg p-8">
      ...
      <p>
        ...
        "Us" or "Our" in this Agreement) refers to QuoteFinder.
      </p>
      ...
      <p>
        <strong>Website</strong> refers to QuoteFinder, accessible from
        https://quotefinder.app
      </p>
      ...
      <ul>
        <li>
          <p>By email: zehaviyishai@gmail.com</p>
        </li>
      </ul>
    </article>
  );
